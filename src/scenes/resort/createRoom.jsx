...
const RoomCreateByResort = () => {
  ...
  const handleFormSubmitHotel = async (values, { setSubmitting,resetForm }) => {
    try {
      ...
      hotelData.append("ResortId", hotelId);
  ...
  return (
    ...
    <div className='container-lg mt-5'>
      <Box m="20px">
        <Header title="Add Room in Resort" subtitle="Create a new Room in Resort" />
...
export default RoomCreateByResort;