...
const RestaurantCreate = () => {
  ...
  const handleFormSubmitHotel = async (values, { setSubmitting,resetForm }) => {
    try {
      ...
      hotelData.append("CuisineType", values.CuisineType);
      ...
      await axiosInstance('ManageRestaurant', 'POST', hotelData);
      alert("Ok")
  ...
  return (
    <div className='container-lg mt-5'>
      <Box m="20px">
        <Header title="Add Restaurant" subtitle="Create a new Restaurant" />
